...
const FIELD_ALIASES: Record<string, string[]> = {
  ...
  size: ['quantity'],
  tac: ['tacPercent'],
  tacpercent: ['tacPercent', 'totalActiveCannabinoidsPercent', 'totalCannabinoidsPercent'],
  totalactivecannabinoids: ['totalActiveCannabinoidsPercent', 'tacPercent', 'totalCannabinoidsPercent'],
  totalactivecannabinoidspercent: ['totalActiveCannabinoidsPercent', 'tacPercent', 'totalCannabinoidsPercent'],
  totalcannabinoids: ['totalCannabinoidsPercent', 'tacPercent', 'totalActiveCannabinoidsPercent'],
  totalcannabinoidspercent: ['totalCannabinoidsPercent', 'tacPercent', 'totalActiveCannabinoidsPercent'],
  tacmg: ['tacMgG'],
  tacmgg: ['tacMgG', 'totalActiveCannabinoidsMgG', 'totalCannabinoidsMgG'],
  tacmggg: ['tacMgG', 'totalActiveCannabinoidsMgG', 'totalCannabinoidsMgG'],
  totalactivecannabinoidsmg: ['totalActiveCannabinoidsMgG', 'tacMgG', 'totalCannabinoidsMgG'],
  totalactivecannabinoidsmgg: ['totalActiveCannabinoidsMgG', 'tacMgG', 'totalCannabinoidsMgG'],
  totalcannabinoidsmg: ['totalCannabinoidsMgG', 'tacMgG', 'totalActiveCannabinoidsMgG'],
  totalcannabinoidsmgg: ['totalCannabinoidsMgG', 'tacMgG', 'totalActiveCannabinoidsMgG'],
  thc: ['thcPercent'],
